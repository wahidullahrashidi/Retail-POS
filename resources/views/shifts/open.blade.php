...
<div class="shift-open-page">
    <div class="open-card">
        ...
        <div class="oc-logo">
            ...
            <div>
                <div class="oc-logo-text">
                    {{ __('messages.afghan_pos') }}
                </div>

                <div class="oc-logo-sub">
                    {{ __('messages.retail_management') }}
                </div>
            </div>
        ...
        <div class="oc-greeting">
            ...
            <h1>
                {{ __('messages.open_your_shift') }}
            </h1>

            <p>
                {{ __('messages.enter_starting_cash_begin_sales') }}
            </p>
        ...
        <div class="oc-clock">
            ...
            <div class="oc-clock-time" id="openShiftClock">
                --:--:--
            </div>

            <div class="oc-clock-date">

                <div class="oc-clock-gregorian">
                    {{ \Carbon\Carbon::now()->format('l, F d') }}
                </div>

                <div class="oc-clock-hijri">
                    {{ $hijriDate ?? '' }}
                </div>
        ...
        <div class="oc-user-strip">
            ...
            <div>
                ...
                <div class="oc-user-role">
                    {{ $user->role?->display_name ?? __('messages.cashier') }}
                </div>

            </div>

            <div class="oc-user-time">
        ...
        <form method="POST" action="{{ route('shift.open') }}">
            ...
            <div class="oc-field">
                ...
                <label class="oc-label">
                    {{ __('messages.starting_cash_in_drawer') }}
                </label>
                ...
                <div class="oc-quick">
                    ...
                    <button type="button"
                        ...
                        {{ $amt === 0 ? __('messages.zero') : number_format($amt) }}
