...
@section('content')
    ...
    <div id="view-shifts" class="view-section hidden">
        ...
        <div class="bg-white rounded-xl border border-card-border p-12 text-center">
            ...
            <p class="text-gray-500 max-w-md mx-auto">This is the Shifts view. Here you would manage employee schedules,
                track clock-in/clock-out times, and monitor shift performance and sales by shift.</p>
        </div>
    </div>
@endsection
